"""
Command dialog and generation handlers.

Imported lazily from entry.CommandCreatedHandler so Fusion startup only pays for
command registration, not the full CAM/geometry/dialog stack.
"""
...
def handle_command_created(args, handlers):
    """Wire dialog and event handlers when the command is invoked."""
